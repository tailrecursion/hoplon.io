...
var len__6059__auto___13161 = arguments.length;
var i__6060__auto___13162 = (0);
while(true){
if((i__6060__auto___13162 < len__6059__auto___13161)){
args__6066__auto__.push((arguments[i__6060__auto___13162]));

var G__13163 = (i__6060__auto___13162 + (1));
i__6060__auto___13162 = G__13163;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq13159){
var G__13160 = cljs.core.first(seq13159);
var seq13159__$1 = cljs.core.next(seq13159);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__13160,seq13159__$1);
});
...
var G__13164 = (function (){
sb.append(ch);

return sb;
})()
;
var G__13165 = cljs.reader.read_char(rdr);
sb = G__13164;
ch = G__13165;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__13168 = (groups[(6)]);
var G__13169 = (10);
return parseInt(G__13168,G__13169);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__13170 = cljs.reader.read_char(rdr);
ch = G__13170;
continue;
} else {
return ch;
...
var G__13171 = (((mret === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret));
a = G__13171;
continue;
} else {
cljs.reader.unread(rdr,ch);
...
var G__13172 = (((o === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o));
a = G__13172;
continue;
}
}
...
;
var G__13174 = cljs.reader.read_char(reader);
buffer = G__13173;
ch = G__13174;
continue;
}
...
if(("\\" === ch)){
var G__13175 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__13176 = cljs.reader.read_char(reader);
buffer = G__13175;
ch = G__13176;
continue;
} else {
...
var G__13177 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__13178 = cljs.reader.read_char(reader);
buffer = G__13177;
ch = G__13178;
continue;
...
var G__13183 = (function (){var G__13181 = buffer;
G__13181.append(nch);

return G__13181;
})();
var G__13184 = cljs.reader.read_char(reader);
buffer = G__13183;
ch = G__13184;
continue;
}
...
var G__13185 = (function (){var G__13182 = buffer;
G__13182.append(ch);

return G__13182;
})();
var G__13186 = cljs.reader.read_char(reader);
buffer = G__13185;
ch = G__13186;
continue;
...
var G__13189 = reader;
var G__13190 = eof_is_error;
var G__13191 = sentinel;
var G__13192 = is_recursive;
reader = G__13189;
eof_is_error = G__13190;
sentinel = G__13191;
is_recursive = G__13192;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__13193 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__13194 = eof_is_error;
var G__13195 = sentinel;
var G__13196 = is_recursive;
reader = G__13193;
eof_is_error = G__13194;
sentinel = G__13195;
is_recursive = G__13196;
continue;
} else {
...
if((res === reader)){
var G__13197 = reader;
var G__13198 = eof_is_error;
var G__13199 = sentinel;
var G__13200 = is_recursive;
reader = G__13197;
eof_is_error = G__13198;
sentinel = G__13199;
is_recursive = G__13200;
continue;
} else {
return res;
}
...
var vec__13205 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13205,(10),null);
var v = vec__13205;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__13206 = months__$1;
var G__13207 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__13206,G__13207) : cljs.reader.days_in_month.call(null,G__13206,G__13207));
...
if(cljs.core.truth_(temp__4423__auto__)){
var vec__13209 = temp__4423__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13209,(7),null);
...
var arr = [];
var seq__13222_13234 = cljs.core.seq(form);
var chunk__13223_13235 = null;
var count__13224_13236 = (0);
var i__13225_13237 = (0);
while(true){
if((i__13225_13237 < count__13224_13236)){
var x_13238 = chunk__13223_13235.cljs$core$IIndexed$_nth$arity$2(null,i__13225_13237);
arr.push(x_13238);

var G__13239 = seq__13222_13234;
var G__13240 = chunk__13223_13235;
var G__13241 = count__13224_13236;
var G__13242 = (i__13225_13237 + (1));
seq__13222_13234 = G__13239;
chunk__13223_13235 = G__13240;
count__13224_13236 = G__13241;
i__13225_13237 = G__13242;
continue;
} else {
var temp__4425__auto___13243 = cljs.core.seq(seq__13222_13234);
if(temp__4425__auto___13243){
var seq__13222_13244__$1 = temp__4425__auto___13243;
if(cljs.core.chunked_seq_QMARK_(seq__13222_13244__$1)){
var c__5804__auto___13245 = cljs.core.chunk_first(seq__13222_13244__$1);
var G__13246 = cljs.core.chunk_rest(seq__13222_13244__$1);
var G__13247 = c__5804__auto___13245;
var G__13248 = cljs.core.count(c__5804__auto___13245);
var G__13249 = (0);
seq__13222_13234 = G__13246;
chunk__13223_13235 = G__13247;
count__13224_13236 = G__13248;
i__13225_13237 = G__13249;
continue;
} else {
var x_13250 = cljs.core.first(seq__13222_13244__$1);
arr.push(x_13250);

var G__13251 = cljs.core.next(seq__13222_13244__$1);
var G__13252 = null;
var G__13253 = (0);
var G__13254 = (0);
seq__13222_13234 = G__13251;
chunk__13223_13235 = G__13252;
count__13224_13236 = G__13253;
i__13225_13237 = G__13254;
continue;
}
} else {
}
...
var obj = {};
var seq__13228_13255 = cljs.core.seq(form);
var chunk__13229_13256 = null;
var count__13230_13257 = (0);
var i__13231_13258 = (0);
while(true){
if((i__13231_13258 < count__13230_13257)){
var vec__13232_13259 = chunk__13229_13256.cljs$core$IIndexed$_nth$arity$2(null,i__13231_13258);
var k_13260 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13232_13259,(0),null);
var v_13261 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13232_13259,(1),null);
(obj[cljs.core.name(k_13260)] = v_13261);

var G__13262 = seq__13228_13255;
var G__13263 = chunk__13229_13256;
var G__13264 = count__13230_13257;
var G__13265 = (i__13231_13258 + (1));
seq__13228_13255 = G__13262;
chunk__13229_13256 = G__13263;
count__13230_13257 = G__13264;
i__13231_13258 = G__13265;
continue;
} else {
var temp__4425__auto___13266 = cljs.core.seq(seq__13228_13255);
if(temp__4425__auto___13266){
var seq__13228_13267__$1 = temp__4425__auto___13266;
if(cljs.core.chunked_seq_QMARK_(seq__13228_13267__$1)){
var c__5804__auto___13268 = cljs.core.chunk_first(seq__13228_13267__$1);
var G__13269 = cljs.core.chunk_rest(seq__13228_13267__$1);
var G__13270 = c__5804__auto___13268;
var G__13271 = cljs.core.count(c__5804__auto___13268);
var G__13272 = (0);
seq__13228_13255 = G__13269;
chunk__13229_13256 = G__13270;
count__13230_13257 = G__13271;
i__13231_13258 = G__13272;
continue;
} else {
var vec__13233_13273 = cljs.core.first(seq__13228_13267__$1);
var k_13274 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13233_13273,(0),null);
var v_13275 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13233_13273,(1),null);
(obj[cljs.core.name(k_13274)] = v_13275);

var G__13276 = cljs.core.next(seq__13228_13267__$1);
var G__13277 = null;
var G__13278 = (0);
var G__13279 = (0);
seq__13228_13255 = G__13276;
chunk__13229_13256 = G__13277;
count__13230_13257 = G__13278;
i__13231_13258 = G__13279;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__13280 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__13280) : cljs.core.atom.call(null,G__13280));
})();
...
var G__13284 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__13284) : pfn.call(null,G__13284));
} else {
if(cljs.core.truth_(dfn)){
var G__13285 = tag;
var G__13286 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__13285,G__13286) : dfn.call(null,G__13285,G__13286));
} else {
